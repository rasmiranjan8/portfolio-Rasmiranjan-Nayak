  ...
  return (
    <section id="contact" className="py-16 bg-blue-950 text-white">
      <div data-aos="fade-up" className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center mt-8 space-y-6 md:space-y-0 md:flex-row md:justify-evenly">
          {/* Email */}
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-gray-300">Phone/WhatsApp:</p>
            <a
              href="tel:9556872621"
              className="text-sm text-white underline hover:text-green-400"
            >
              +91 955 687 2621
            </a>
            <p className="flex text-sm items-center mt-2">
              <FaWhatsapp className="text-green-400 mr-2" /> Available on
              WhatsApp
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-gray-300">LinkedIn:</p>
            <a
              href="www.linkedin.com/in/rasmiranjan-nayak-20389a286"
              className="text-sm text-white underline hover:text-blue-500"
              target="_blank"
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-gray-300">GitHub:</p>
            <a
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-gray-300">Instagram:</p>
            <a
              href="#"
